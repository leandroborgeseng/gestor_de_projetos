...
export default function SkillsModal({ isOpen, onClose }: SkillsModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[100] overflow-y-auto">
      <div className="bg-gray-800 rounded-lg shadow-xl w-full max-w-4xl m-4 my-8 max-h-[90vh] flex flex-col">
        <div className="flex justify-between items-center p-6 border-b border-gray-700 flex-shrink-0">
          <h2 className="text-2xl font-bold text-gray-100">Gerenciar Habilidades</h2>
          <button
            onClick={() => {
              onClose();
              setShowForm(false);
        ...
        <div className="p-6 overflow-y-auto flex-1">
          ...
          {showForm && (
            <form
              ...
              className="bg-gray-700 rounded-lg shadow p-6 mb-6"
            >
              <div className="space-y-4">
                <div>
