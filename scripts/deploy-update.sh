...
echo "  • Monday Board - View estilo Monday.com completa"
echo "  • Filtros avançados (pessoas, tags, sprints, datas, horas)"
echo "  • Ordenação por múltiplos campos"
echo "  • Criação de subtarefas inline"
echo "  • Seleção múltipla e ações em lote"
echo "  • Colunas customizáveis pelo usuário"
echo "  • Edição inline de texto"
echo "  • Exportação para CSV/Excel"
echo "  • Atalhos de teclado"
echo "  • Coluna de progresso visual"
echo "  • Redimensionamento de colunas"
echo "  • Persistência de configurações"
echo ""
